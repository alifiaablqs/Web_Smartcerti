...
<div class="sidebar">
    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
                <a href="{{ url('/vendorpelatihan') }}"
                    class="nav-link {{ $activeMenu == 'vendorpelatihan' ? 'active' : '' }}">
                    <i class="nav-icon fas fa-building"></i>
                    <p>Vendor Pelatihan</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ url('/vendorsertifikasi') }}"
                    class="nav-link {{ $activeMenu == 'vendorsertifikasi' ? 'active' : '' }}">
                    <i class="nav-icon fas fa-building"></i>
            ...
            <li class="nav-item">
                <a href="{{ url('/jenispelatihan') }}"
                    class="nav-link {{ $activeMenu == 'jenispelatihan' ? 'active' : '' }}">
            ...
            <li class="nav-item">
                <a href="{{ url('/jenissertifikasi') }}"
                    class="nav-link {{ $activeMenu == 'jenissertifikasi' ? 'active' : '' }}">
                    <i class="nav-icon fas fa-list-alt"></i>
            ...
            <li class="nav-item">
                <a href="{{ url('/bidangminat') }}"
                    class="nav-link {{ $activeMenu == 'bidangminat' ? 'active' : '' }}">
            ...
            <li class="nav-item">
                <a href="{{ url('/pimpinanpelatihan') }}"
                    class="nav-link {{ $activeMenu == 'pimpinanpelatihan' ? 'active' : '' }}">
                    <i class="nav-icon far fa-bookmark"></i>
                    <p>Pelatihan</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ url('/pimpinansertifikasi') }}"
                    class="nav-link {{ $activeMenu == 'pimpinansertifikasi' ? 'active' : '' }}">
                    <i class="nav-icon far fa-bookmark"></i>
                    <p>Sertifikasi</p>
                </a>
            </li>

            <li class="nav-header">Management Perminataan</li>
            <li class="nav-item">
                <a href="{{ url('/penerimaanpermintaan') }}"
                    class="nav-link {{ $activeMenu == 'penerimaanpermintaan' ? 'active' : '' }}">
                    <i class="nav-icon fas fa-list-alt"></i>
