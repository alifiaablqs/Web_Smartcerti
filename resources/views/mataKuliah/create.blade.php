<form action="{{ url('/matakuliah/store') }}" method="POST" id="form-tambah">
    @csrf
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input value="" type="text" name="kode_matakuliah" id="kode_matakuliah" class="form-control" required>
                    <small id="error-kode_matakuliah" class="error-text form-text text-danger"></small>
                </div>
                <div class="form-group">
                    <label>Nama Mata Kuliah</label>
                    <input value="" type="text" name="nama_matakuliah" id="nama_matakuliah" class="form-control" required>
