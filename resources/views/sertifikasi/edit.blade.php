        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <select name="id_vendor_sertifikasi" id="id_vendor_sertifikasi" class="form-control" required>
                        ...
                        @foreach ($vendorSertifikasi as $l)
                            <option {{ ($l->id_vendor_sertifikasi == $sertifikasi->id_vendor_sertifikasi)? 'selected' : ''}} value="{{ $l->id_vendor_sertifikasi }}">{{ $l->nama }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select name="id_jenis_sertifikasi" id="id_jenis_sertifikasi" class="form-control" required>
                        ...
                        @foreach ($jenisSertifikasi as $l)
                            <option {{ ($l->id_jenis_sertifikasi == $sertifikasi->id_jenis_sertifikasi)? 'selected' : '' }} value="{{ $l->id_jenis_sertifikasi }}">{{ $l->nama_jenis_sertifikasi }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select name="id_periode" id="id_periode" class="form-control" required>
                        ...
                        @foreach ($periode as $l)
                            <option {{ ($l->id_periode == $sertifikasi->id_periode)? 'selected' : '' }} value="{{ $l->id_periode }}">{{ $l->tahun_periode }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input value ="{{ $sertifikasi->no_sertifikasi }}" type="text" name="no_sertifikasi" id="no_sertifikasi" class="form-control" required>
                ...
                <div class="form-group">
                    <label>Jenis</label>
                    <select value ="{{ $sertifikasi->jenis }}" name="jenis" id="jenis" class="form-control" required>
                ...
                <div class="form-group">
                    ...
                    <input value ="{{ $sertifikasi->bukti_sertifikasi }}" type="file" name="bukti_sertifikasi" id="bukti_sertifikasi" class="form-control" required>
                ...
                <div class="form-group">
                    ...
                    <input value ="{{ $sertifikasi->masa_berlaku }}" type="date" name="masa_berlaku" id="masa_berlaku" class="form-control" required>
                ...
                <div class="form-group">
                    ...
                    <input value ="{{ $sertifikasi->kuota_peserta }}" type="number" name="kuota_peserta" id="kuota_peserta" class="form-control" required>
                ...
                <div class="form-group">
                    <label>Biaya</label>
                    <input value ="{{ $sertifikasi->biaya }}" type="number" name="biaya" id="biaya" class="form-control" required>
                ...
                <div class="form-group">
                    ...
                    <select multiple="multiple" name="id_bidang_minat[]" id="id_bidang_minat"
                        ...
                        @foreach ($bidangMinat as $item)
                            <option {{ $sertifikasi->bidang_minat_sertifikasi->contains($item->id_bidang_minat) ? 'selected' : '' }} value="{{ $item->id_bidang_minat }}">{{ $item->nama_bidang_minat }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select multiple="multiple" name="id_matakuliah[]" id="id_matakuliah"
                        ...
                        @foreach ($mataKuliah as $item)
                            <option {{ $sertifikasi->mata_kuliah_sertifikasi->contains($item->id_matakuliah) ? 'selected' : '' }} value="{{ $item->id_matakuliah }}">{{ $item->nama_matakuliah }}</option>
                        @endforeach
                    </select>
